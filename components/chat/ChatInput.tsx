    ...
    export function ChatInput({ onSend, isLoading }: ChatInputProps) {
      ...
      return (
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="self-stretch text-center text-slate-400 text-sm font-medium font-['Plus Jakarta Sans'] leading-tight">slothGPT can make mistakes. Check our Terms &amp; Conditions.</div>
          </form>
      );
    }
